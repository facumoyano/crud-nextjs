...
const Home = () => {
    const { tareas, eliminarTarea, editarTarea, setTareas } = useCrud();
    const router = useRouter();

    useEffect(() => {
        const obtenerLS = window.localStorage.getItem("tareas");
        if (obtenerLS !== null) setTareas(JSON.parse(obtenerLS));
    }, []);
                                ...
                                <Flex flexDirection="column" gap={2}>
                                    ...
                                    >
                                        <Box
                                            ...
                                            height="15px"
                                            borderRadius="50%"
                                            backgroundColor= {tarea.estado === 'finalizada' ? 'green.400' : 'red.400'}
                                        ></Box>
                                        <Text>
